...
const BIBLICAL_EVENTS = {
  ...
  last_supper: {
    ...
    era: 'new_testament',
    description: 'On the eve of his crucifixion, Jesus shares a final Passover meal with his disciples, washes their feet, foretells betrayal, and institutes the Lord\'s Supper.',
    bibleRefs: ['Matthew 26:17-30', 'John 13:1-17:26'],
    location: 'jerusalem',
    characters: ['jesus', 'peter', 'john_apostle', 'judas_iscariot', 'thomas'],
    category: 'covenant',
    steps: [
      { stepId: 'preparation', title: 'Preparing the Passover', description: 'Jesus sends Peter and John to find an upper room. At evening he reclines at table with the twelve.' },
      { stepId: 'washing_feet', title: 'Washing Feet', description: 'Jesus rises, takes a towel, and washes the disciples\' feet. Peter protests. Jesus says, "Unless I wash you, you have no part with me."' },
      { stepId: 'betrayal_announced', title: 'Betrayal Announced', description: 'Jesus says one of them will betray him. They are sorrowful. He identifies Judas by handing him the bread.' },
      { stepId: 'bread_and_cup', title: 'Bread and Cup', description: 'Jesus takes bread, gives thanks, breaks it: "This is my body." He takes the cup: "This is my blood of the covenant, poured out for many for forgiveness."' },
      { stepId: 'hymn', title: 'Hymn and Gethsemane', description: 'They sing a hymn and go out to the Mount of Olives.' },
    ],
  },
  ...
  gethsemane: {
    ...
    title: 'Gethsemane',
    era: 'new_testament',
    description: 'In the Garden of Gethsemane, Jesus prays in agony as his disciples sleep, surrenders to the Father\'s will, and is then arrested.',
    bibleRefs: ['Matthew 26:36-56', 'Luke 22:39-53'],
    location: 'gethsemane',
    characters: ['jesus', 'peter', 'judas_iscariot'],
    category: 'passion',
    steps: [
      { stepId: 'entering_garden', title: 'Into the Garden', description: 'Jesus enters Gethsemane with the disciples. He says, "My soul is overwhelmed with sorrow to the point of death."' },
      { stepId: 'prayer', title: 'Jesus Prays', description: 'Jesus falls to the ground and prays: "Father, if it is possible, take this cup from me. Yet not as I will, but as you will." Three times.' },
      { stepId: 'disciples_sleep', title: 'Disciples Sleep', description: 'Each time Jesus returns to Peter, James, and John, he finds them asleep. "Could you not watch with me one hour?"' },
      { stepId: 'betrayal_kiss', title: 'The Kiss of Betrayal', description: 'Judas arrives with a crowd carrying swords and clubs. He greets Jesus with a kiss — the pre-arranged signal.' },
      { stepId: 'arrest', title: 'Jesus Arrested', description: 'Peter cuts off the servant\'s ear. Jesus heals him. The disciples flee. Jesus is led away.' },
    ],
  },
  ...
  crucifixion: {
    ...
    era: 'new_testament',
    description: 'Jesus is tried, condemned, crucified between two criminals on Golgotha, breathes his last as darkness covers the land, and is buried in a borrowed tomb.',
    bibleRefs: ['Matthew 27:32-66', 'John 19:16-42'],
    location: 'golgotha',
    characters: ['jesus', 'mary', 'mary_magdalene', 'john_apostle'],
    category: 'passion',
    steps: [
      { stepId: 'carrying_cross', title: 'Carrying the Cross', description: 'Jesus carries his own cross toward Golgotha — the Place of the Skull. Simon of Cyrene is compelled to help.' },
      { stepId: 'nailed', title: 'Nailed to the Cross', description: 'They crucify Jesus between two criminals. The sign above him reads: "Jesus of Nazareth, King of the Jews."' },
      { stepId: 'seven_words', title: 'The Seven Words', description: 'Jesus speaks: "Father forgive them"; "Today you will be with me in paradise"; "It is finished." Darkness covers the land.' },
      { stepId: 'death', title: 'Jesus Breathes His Last', description: 'Jesus cries out with a loud voice and gives up his spirit. The temple curtain tears in two. The earth shakes.' },
      { stepId: 'burial', title: 'Burial', description: 'Joseph of Arimathea and Nicodemus wrap Jesus\'s body in spices and linen and lay him in a new tomb.' },
    ],
  },
  ...
  road_to_emmaus: {
    ...
    era: 'new_testament',
    description: 'Two disciples walk to Emmaus on resurrection day discussing events; an unrecognized stranger joins them, opens the Scriptures, and is revealed as the risen Jesus at the breaking of bread.',
    bibleRefs: ['Luke 24:13-35'],
    location: 'emmaus',
    characters: ['jesus'],
    category: 'resurrection',
    steps: [
      { stepId: 'walking', title: 'Two Disciples Walking', description: 'Two disciples walk to Emmaus, seven miles from Jerusalem, discussing the crucifixion and the empty tomb with sad faces.' },
      { stepId: 'stranger_joins', title: 'A Stranger Joins', description: 'Jesus comes near and walks with them, but they are kept from recognizing him. He asks what they are discussing.' },
      { stepId: 'scriptures_opened', title: 'Scriptures Opened', description: '"Did not the Messiah have to suffer these things?" Beginning with Moses and all the Prophets, Jesus explains what Scripture says about himself.' },
      { stepId: 'stay_with_us', title: 'Stay With Us', description: 'As they reach Emmaus they urge him to stay. He goes in with them. At the table he takes bread, blesses, breaks, and gives it to them.' },
      { stepId: 'recognized', title: 'Eyes Opened', description: 'Their eyes are opened and they recognize him — and he vanishes. "Were not our hearts burning within us while he spoke?"' },
    ],
  },
  ...
  ascension: {
    ...
    title: 'The Ascension',
    era: 'new_testament',
    description: 'Forty days after the resurrection, Jesus leads the disciples to the Mount of Olives, blesses them, and is taken up into heaven while they watch.',
    bibleRefs: ['Acts 1:1-11', 'Luke 24:50-53'],
    location: 'mount_of_olives',
    characters: ['jesus', 'peter'],
    category: 'victory',
    steps: [
      { stepId: 'forty_days', title: 'Forty Days of Teaching', description: 'For forty days after his resurrection, Jesus appears to the disciples and speaks about the kingdom of God.' },
      { stepId: 'wait_for_spirit', title: 'Wait for the Promise', description: 'Jesus commands them to wait in Jerusalem for the promised Holy Spirit. "You will be my witnesses to the ends of the earth."' },
      { stepId: 'lifted_up', title: 'Taken Up', description: 'While he is blessing them, he is taken up before their eyes, and a cloud hides him from their sight.' },
      { stepId: 'angels', title: 'Two Men in White', description: 'Two men in white appear: "Men of Galilee, why do you stand looking at the sky? This same Jesus will come back in the same way."' },
      { stepId: 'worship', title: 'Worship and Return', description: 'The disciples worship and return to Jerusalem with great joy, continually in the temple praising God.' },
    ],
  },
  ...
  creation: {
    ...
    characters: [],
    steps: [
      { stepId: 'day1', title: 'Day 1 — Light', description: 'God separates light from darkness.' },
      { stepId: 'day2', title: 'Day 2 — Sky', description: 'God creates the expanse of the sky.' },
      { stepId: 'day3', title: 'Day 3 — Land & Plants', description: 'Dry land appears; vegetation grows.' },
      { stepId: 'day4', title: 'Day 4 — Stars & Sun', description: 'The sun, moon, and stars are set in place.' },
      { stepId: 'day5', title: 'Day 5 — Sea & Sky creatures', description: 'Fish and birds fill the waters and skies.' },
      { stepId: 'day6', title: 'Day 6 — Animals & Humanity', description: 'Land animals and humankind are created.' },
      { stepId: 'day7', title: 'Day 7 — Rest', description: 'God rests and blesses the seventh day.' },
    ],
    triggers: [],
    category: 'origins',
  },
  ...
  great_flood: {
    ...
    characters: ['noah'],
    steps: [
      { stepId: 'ark_built', title: 'Building the Ark', description: 'Noah constructs the Ark as commanded.' },
      { stepId: 'animals_board', title: 'Animals Enter', description: 'Two of every kind board the Ark.' },
      { stepId: 'rain_begins', title: 'The Flood Begins', description: 'Rain falls for forty days and nights.' },
      { stepId: 'waters_recede', title: 'Waters Recede', description: 'The dove returns with an olive branch.' },
      { stepId: 'covenant', title: 'Rainbow Covenant', description: 'God sets His rainbow as a sign of His covenant.' },
    ],
  ...
  exodus_plagues: {
    ...
    characters: ['moses'],
    steps: [
      { stepId: 'plague_blood', title: 'Water to Blood', description: 'The Nile turns to blood.' },
      { stepId: 'plague_frogs', title: 'Frogs', description: 'Frogs cover the land of Egypt.' },
      { stepId: 'plague_gnats', title: 'Gnats', description: 'Dust becomes gnats throughout Egypt.' },
      { stepId: 'plague_flies', title: 'Flies', description: 'Dense swarms of flies fill Pharaoh\'s palace.' },
      { stepId: 'plague_livestock', title: 'Livestock', description: 'All Egyptian livestock die.' },
      { stepId: 'plague_boils', title: 'Boils', description: 'Festering boils break out on people and animals.' },
      { stepId: 'plague_hail', title: 'Hail', description: 'The worst hailstorm in Egypt\'s history.' },
      { stepId: 'plague_locusts', title: 'Locusts', description: 'Locusts devour everything the hail left.' },
      { stepId: 'plague_darkness', title: 'Darkness', description: 'Three days of total darkness.' },
      { stepId: 'plague_firstborn', title: 'Death of Firstborn', description: 'Every firstborn in Egypt dies at midnight.' },
    ],
  ...
  parting_red_sea: {
    ...
    characters: ['moses'],
    steps: [
      { stepId: 'pursued', title: 'Pharaoh\'s Army Pursues', description: 'The Egyptian army closes in on Israel.' },
      { stepId: 'staff_raised', title: 'Moses Raises His Staff', description: 'Moses stretches out his hand over the sea.' },
      { stepId: 'walls_of_water', title: 'Walls of Water', description: 'The sea parts — walls of water on either side.' },
      { stepId: 'crossing', title: 'Israel Crosses', description: 'All Israel passes through on dry ground.' },
      { stepId: 'sea_returns', title: 'Sea Returns', description: 'The sea covers the entire Egyptian army.' },
    ],
  ...
  ten_commandments: {
    ...
    characters: ['moses'],
    steps: [
      { stepId: 'sinai_cloud', title: 'Cloud on the Mountain', description: 'A thick cloud covers Sinai; thunder and lightning.' },
      { stepId: 'moses_ascends', title: 'Moses Ascends', description: 'Moses climbs into the presence of God.' },
      { stepId: 'commandments_given', title: 'Commandments Given', description: 'God speaks the Ten Commandments.' },
      { stepId: 'tablets_received', title: 'Stone Tablets', description: 'Moses receives two tablets written by the finger of God.' },
    ],
  ...
  david_and_goliath: {
    ...
    characters: ['david'],
    steps: [
      { stepId: 'goliath_taunts', title: 'Goliath\'s Challenge', description: 'Goliath mocks Israel and defies the armies of God.' },
      { stepId: 'david_volunteers', title: 'David Steps Forward', description: 'David refuses armour and takes his sling and five smooth stones.' },
      { stepId: 'sling_thrown', title: 'The Stone is Thrown', description: 'The stone strikes Goliath\'s forehead and he falls.' },
      { stepId: 'victory', title: 'Victory!', description: 'The Philistines flee; Israel pursues.' },
    ],
  ...
  birth_of_jesus: {
    ...
    steps: [
      { stepId: 'no_room', title: 'No Room at the Inn', description: 'Mary and Joseph arrive in Bethlehem.' },
      { stepId: 'birth', title: 'Jesus is Born', description: 'Mary gives birth and lays Him in a manger.' },
      { stepId: 'angels_announce', title: 'Angels to Shepherds', description: 'A great company of angels praise God.' },
      { stepId: 'shepherds_visit', title: 'Shepherds Visit', description: 'The shepherds find Mary, Joseph and the baby.' },
      { stepId: 'wise_men', title: 'Wise Men Follow the Star', description: 'Magi from the East follow the star and bring gifts.' },
    ],
  ...
  sermon_on_mount: {
    ...
    characters: ['jesus'],
    steps: [
      { stepId: 'beatitudes', title: 'The Beatitudes', description: '"Blessed are the poor in spirit…"' },
      { stepId: 'salt_light', title: 'Salt and Light', description: '"You are the light of the world."' },
      { stepId: 'lords_prayer', title: "The Lord's Prayer", description: '"Our Father in heaven, hallowed be your name…"' },
      { stepId: 'golden_rule', title: 'The Golden Rule', description: '"Do to others what you would have them do to you."' },
    ],
  ...
  resurrection: {
    ...
    characters: ['jesus'],
    steps: [
      { stepId: 'empty_tomb', title: 'The Empty Tomb', description: 'The stone is rolled away; the tomb is empty.' },
      { stepId: 'angel_speaks', title: 'Angel Speaks', description: '"He is not here; He has risen, just as He said."' },
      { stepId: 'jesus_appears', title: 'Jesus Appears', description: 'Jesus appears to Mary Magdalene and the disciples.' },
      { stepId: 'great_commission', title: 'The Great Commission', description: '"Go and make disciples of all nations."' },
    ],
  ...
  pentecost: {
    ...
    characters: ['paul'],
    steps: [
      { stepId: 'wind_fills_room', title: 'Sound of Wind', description: 'A sound like a violent wind fills the whole house.' },
      { stepId: 'tongues_of_fire', title: 'Tongues of Fire', description: 'What seemed like tongues of fire rested on each of them.' },
      { stepId: 'speaking_languages', title: 'Speaking in Languages', description: 'Each person heard in their own native language.' },
      { stepId: 'peter_preaches', title: 'Peter Preaches', description: 'Peter stands and addresses the crowd.' },
      { stepId: 'three_thousand', title: 'Three Thousand Saved', description: 'About three thousand were added to their number that day.' },
    ],
